...
def run(
        weights= r'D:\yolov5\runs\weights\p2.pt', #ROOT / 'yolov5s.pt',  # model path or triton URL
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            for rect_tick in range(0,danger_level):
                im0 = cv2.rectangle(im0, (400 + (40*rect_tick), 400), (420 + (40*rect_tick), 440), danger_color, -1)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default= r'D:\yolov5\runs\weights\p2.pt', help='model path or triton URL')
